        ...
        messages: [
          {
            role: "system",
            content:
              "Return strict JSON: {trends:[string],top:[{title,hook,thumbs:[string],script}],plan:[{day:number,idea:string}]}. Optimize for viral short-form dark-history content.",
          },
          {
            role: "user",
            content: `Topic: ${topic}`,
        ...
        messages: [
          {
            role: "system",
            content:
              "Return strict JSON: {top:[{title,hook,thumbnail,script}],series:[{part,title}],plan:[{day:number,idea:string}]}.",
          },
          {
            role: "user",
            content: `Topic: ${topic}`,
        ...
        messages: [
          {
            role: "system",
            content:
              "Return strict JSON: {analysis:string,improvements:[string],nextIdeas:[{title,hook,reason}]}.",
          },
          {
            role: "user",
        ...
        messages: [
          {
            role: "system",
            content:
              "Return strict JSON: {title,hook,summary}.",
          },
          {
            role: "user",
            content: `Topic: ${topic}`,
